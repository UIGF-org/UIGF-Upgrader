...
declare namespace UIGF2 {
  /**
   * @description UIGF2.2数据
   * @since 2.0.0
   * @interface Schema2
   * @property {Info2} info - 导出信息
   * @property {Array<GachaItem2>} list - 卡池数据
   * @returns Schema2
   */
  type Schema2 = { info: Info2; list: Array<GachaItem2> };
  ...
  /**
   * @description UIGF2.2+ 卡池数据
   * @since 2.0.0
   * @interface GachaItem2
